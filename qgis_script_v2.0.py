# -*- coding: utf-8 -*-
"""point_in_polygon_v2.0

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12UpP4cf4G4FUq_Ap3ccn0EjFxmfhnNJe
...
<!-- TODO -->
<!-- Break up into multiple files and take in CLI arguments -->
...
def address_coordinates(address):
    ...
    lat_long_tup = None
    if len(response) == 0:
      print('Address is not recognized')
    else:
...
def contains_address(address, path_to_shp_file):
    ...
    return coordinate_aq_code(coordinate, path_to_shp_file)
